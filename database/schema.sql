-- =============================================================================
-- ESQUEMA DE BASE DE DATOS - SISTEMA DE GESTIÓN DE SOLICITUDES INTERNAS (SB)
-- Motor: Microsoft SQL Server (Transact-SQL)
-- =============================================================================

IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'SB_GestionSolicitudes')
BEGIN
...
-- 4. Tabla EntidadesGubernamentales (Estructura Oficial XLSX)
IF OBJECT_ID('dbo.EntidadesGubernamentales', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('dbo.HistorialesEstado', 'U') IS NULL
BEGIN
...
BEGIN
    CREATE TABLE dbo.Notificaciones (
        ...
        CONSTRAINT FK_Notificaciones_UsuarioDestino FOREIGN KEY (UsuarioDestinoId) REFERENCES dbo.Usuarios(Id)
    );
END
GO
